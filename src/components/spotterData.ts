...
export const defaultTriggers: TriggerEvent[] = [
  ...
  { 
    ...
    phrases: [
      ...
      "Left side's got a snake—don't let him slither past, you cunt!",
  ...
  { 
    ...
    phrases: [
      ...
      "Right side's got a snake—don't let him slither past, you cunt!",
  ...
  { 
    ...
    phrases: [
      ...
      "Watch your left, cunt—two chumps are gunning for your glory!",
  ...
  { 
    ...
    phrases: [
      ...
      "Watch your right, cunt—two chumps are gunning for your glory!",
  ...
  { 
    ...
    phrases: [
      ...
      "You're boxed in, you blind cunt—two fuckers are sniffing your exhaust!",
      ...
      "Both sides got cockroaches—squash 'em or you're roadkill, cunt!",
      ...
      "Cars left and right, you cunt—they're closer than a drunk's bad breath!",
